document.addEventListener("DOMContentLoaded", function () {
    ...
    globalSearchInput.addEventListener("input", () => {
        ...
        if (!term) {
          renderGlobalSearchResults([]);  // ou limpe a área de resultados
          return;
        }
      
        // Caso contrário, filtramos normalmente:
    ...
    function renderGlobalSearchResults(results) {
        ...
        results.forEach(app => {
          ...
          btn.addEventListener("click", () => {
            // Seleciona o dia do compromisso, atualiza a exibição e abre o modal
            selectedDate = app.date;
            displayDayAppointments(app.date);
            document.getElementById("calendar").scrollIntoView({ behavior: "smooth" });
      
            // Busca o elemento do dia no calendário com o data-date igual a app.date
